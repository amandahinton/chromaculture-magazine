...
function Discover() {
    ...
    return (
        <div className="discover-container">
            ...
            <p>Chromaculture is for artists, designers, and those obsessed with all things color! Stop by to see the latest articles we've gathered, and log in to bookmark your favorites or join us in the comments section.</p>
            </div>
